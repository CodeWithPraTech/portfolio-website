...
ENV_PATH = ROOT / ".env"
DOCX_PATH = ROOT / "Statistics_Day_1_Notes.docx"
UPLOAD_PATH = ROOT / "Statistics_Day_1_Notes_upload.docx"
PAGE_ID = "377fb1cd-3ed7-81ab-ba25-f3f6f89fa9dc"
...
def main():
    ...
    file_path = UPLOAD_PATH if UPLOAD_PATH.exists() else DOCX_PATH
    ...
    body, content_type = multipart_body("file", file_path, upload_name=DOCX_PATH.name)
                ...
                "rich_text": [
                    {
                        "type": "text",
                        "text": {
                            "content": "Day 1 Word notes uploaded. Covers data types, data type ratio, central tendency, spread, percentiles, outliers, robust statistics, EDA workflow, interview answers, and practice questions."
                        },
                    }
                ]
            },
