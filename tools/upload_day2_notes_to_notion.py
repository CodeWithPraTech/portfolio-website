...
ENV_PATH = ROOT / ".env"
DOCX_PATH = ROOT / "Statistics_Day_2_Probability_Counting_Notes.docx"
PAGE_ID = "377fb1cd-3ed7-81cc-ae8b-f1eeb8a867e0"
                ...
                "rich_text": [
                    {
                        ...
                        "text": {
                            "content": (
                                "Day 2 Word notes uploaded. Covers probability basics, sample spaces, events, "
                                "complements, union/intersection, independent vs mutually exclusive events, "
                                "multiplication rule, permutations, combinations, inclusion-exclusion, replacement, "
                                "at-least-one problems, business use cases, interview traps, and practice answers."
                            )
                        },
                    }
                ]
