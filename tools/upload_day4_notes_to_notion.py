...
ENV_PATH = ROOT / ".env"
DOCX_PATH = ROOT / "Statistics_Day_4_Bayes_Fraud_Risk_Notes.docx"
PAGE_ID = "377fb1cd-3ed7-81e7-898a-c4000c9f2e7f"
                ...
                "rich_text": [
                    {
                        ...
                        "text": {
                            "content": (
                                "Day 4 Word notes uploaded. Covers Bayes theorem, base rates, false positives, "
                                "false negatives, posterior probability, screening tests, fraud/default examples, "
                                "confusion-matrix-to-posterior mapping, calibration, prior shift, threshold policy, "
                                "research engineer model monitoring, and BFSI cost-sensitive decisions."
                            )
                        },
                    }
                ]
