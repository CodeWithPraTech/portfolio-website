const statisticsSessions = [
  ...
  { day: "Day 05", date: "2026-06-11", reminderDate: "2026-06-11", week: "Week 1", sessionType: "Core", status: "Pending", progress: 0, focusArea: "Random Variables, PMF/CDF, Expectation", topics: ["Probability", "Distributions"], resources: "BH Ch. 3", importantConcepts: "Discrete and continuous random variables, PMF, PDF, CDF, expectation, linearity of expectation.", practiceQuestions: "Compute expected value for transaction loss, customer value, and product reward scenarios.", tasks: "Read BH random variables, solve EV problems, write expected loss formula notes.", hours: 1.5, notes: "Upload expectation formula sheet.", notesUpload: "", visible: true },
