const statisticsSessions = [
  ...
  { day: "Day 06", date: "2026-06-12", reminderDate: "2026-06-12", week: "Week 1", sessionType: "Core", status: "In Progress", progress: 50, focusArea: "Variance, Covariance, Correlation", topics: ["Descriptive Statistics", "Probability"], resources: "BH Ch. 4; PSDS correlation sections", importantConcepts: "Variance, standard deviation, covariance, correlation, covariance matrix, correlation vs causation.", practiceQuestions: "Interpret correlation in credit score, income, default risk, and product usage examples.", tasks: "Read variance/covariance sections, solve 6 calculation and interpretation questions.", hours: 1.5, notes: "Detailed Word notes created for Day 6 covering variance, covariance, correlation, research engineer depth, data science use cases, and BFSI applications.", notesUpload: "Statistics_Day_6_Variance_Covariance_Correlation_Notes.docx", visible: true },
